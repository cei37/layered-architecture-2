...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createUser(userDTO: UserDTO, _options?: Configuration): Promise<RequestContext> {
        ...
        if (userDTO === null || userDTO === undefined) {
            throw new RequiredError("DefaultApi", "createUser", "userDTO");
        }
    ...
    public async getUserById(id: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("DefaultApi", "getUserById", "id");
        }
    ...
    public async updateUser(id: number, userDTO: UserDTO, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'userDTO' is not null or undefined
        if (userDTO === null || userDTO === undefined) {
            throw new RequiredError("DefaultApi", "updateUser", "userDTO");
        }
...
export class DefaultApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserByIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<UserDTO >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUsersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<UserDTO> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
